  ...
  const terms = [
    {
      ...
      description: 'By registering on Aurora LMS, you agree to provide truthful credentials and accept responsibility for maintaining the confidentiality of your session tokens and profile dashboard.',
    },
    {
      icon: CheckCircle2,
    ...
    },
    {
      ...
      description: 'All mock compilers, terminal scripts, and learning sandboxes are provided on an "as is" basis. Aurora LMS is not liable for system damage, compiler compilation errors, or local compiler crashes.',
    },
  ];
      ...
      <motion.div variants={item} className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-violet-600/20 to-purple-600/20 border border-white/10 p-8 text-center md:text-left">
        ...
        <div className="relative z-10 flex flex-col md:flex-row justify-between items-center gap-6">
          <div>
            ...
            <p className="text-slate-300 mt-2 text-lg">Terms and user guidelines for using the Aurora LMS platform.</p>
          </div>
