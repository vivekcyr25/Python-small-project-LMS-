...
const PrivacyPolicyPage = () => {
  ...
  const sections = [
    ...
    },
    {
      ...
      description: 'AIPS LMS integrates with Firebase Authentication to handle OAuth Google Sign-in. Firebase secures these operations, and only verification hashes are exchanged with our backend. In development/mock mode, credentials remain entirely local to your sandbox.',
    },
    {
      icon: Database,
