...
const GoogleLoginButton: React.FC<Props> = ({ className }) => {
  ...
  const [statusText, setStatusText] = useState<'idle' | 'connecting' | 'signing_in'>('idle');
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      setStatusText('signing_in');
      // Exchange for backend app JWT
    ...
    <div className="w-full">
      ...
      >
        {loading ? (
          ...
          /* Simple "G" logo SVG in Google colours */
